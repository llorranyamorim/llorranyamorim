...
Me chamo Lorrany Amorim de Oliveira, tenho 30 anos e sou natural de Brasilia/DF. Atualmente, estou cursando Análise e Desenvolvimento de Sistemas na UNIP, finalizando em Dezembro de 2026. Apaixonada por tecnologia, me identifiquei com essa área pois trago comigo um perfil analítico, proativo e comprometido com qualidade de ponta a ponta, atenção aos detalhes e por acreditar que a qualidade do software impacta diretamente a experiência e o dia a dia das pessoas. Possuo uma visão sistêmica e habilidade de antecipar falhas antes que virem problemas. 

### 📚 Estudos

Atualmente aprimorando meus conhecimentos em testes de software, com foco em testes manuais, introdução à automação e em preparação para a certificação CTFL (Certified Tester Foundation Level).
...
[Projeto de elaboração de plano de teste e casos de teste](https://github.com/llorranyamorim/CasosdeTeste_TesteTecnico)
...
[Testes de API com Cypressa]([https://github.com/llorranyamorim/CasosdeTeste_TesteTecnico](https://github.com/llorranyamorim/Mentoria_APIcomCypress))
